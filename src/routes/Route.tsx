  ...
  const DONOR_MENU = {
    QRCodeScannerScreen: {
      ...
      navigationOptions: {
        ...
        drawerIcon: (
          <SvgImage source={require('@assets/icons/ICON_QR_CODE(WHITE).svg')} />
        )
      }
    },
    DashboardScreen: {
      ...
      navigationOptions: {
        ...
        drawerIcon: (
          <SvgImage
            source={require('@assets/icons/ICON_DONATION(WHITE).svg')}
          />
        )
      }
    }
  ...
  const COMMON_MENU = {
    ...
    LogoutScreen: {
      ...
      navigationOptions: {
        drawerLabel: 'Log Out',
        drawerIcon: (
          <SvgImage source={require('@assets/icons/ICON_LOGOUT(WHITE).svg')} />
        )
      }
    }
  };
...
// Drawer Navigator
export const Drawer = createDrawerNavigator(donorOrClientDrawer(), {
