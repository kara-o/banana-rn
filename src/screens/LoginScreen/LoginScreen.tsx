...
import { Title, LinkButton, SpacerInline, InputLabel, Icon } from '@elements';
  ...
  const handleLogin = async () => {
    ...
    switch (statusCode) {
      case 202: {
        ...
        navigate('ApplicationPendingScreen');
        return;
      }
      case 401:
    ...
    <View style={styles.outerContainer}>
      ...
      <View style={styles.passwordContainer}>
        ...
        <View style={styles.iconContainer}>
          <TouchableWithoutFeedback onPress={() => setHidePwd(!hidePwd)}>
